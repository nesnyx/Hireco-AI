                ...
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        <div className="space-y-3">
                            {candidate.criteriaScores.map(({ criterion, score, detail }) => {
...
const ComparingPage = () => {
    ...
    const criteriaHeaders = candidates[0].criteriaScores.map(c => c.criterion);
                    ...
                    <div className="grid gap-px" style={{ gridTemplateColumns: `minmax(250px, 1.5fr) repeat(${criteriaHeaders.length}, minmax(150px, 1fr))` }}>
                        ...
                        {candidates.map(candidate => (
                            <React.Fragment key={candidate.id}>
                                ...
                                {candidate.criteriaScores.map(({ criterion, score }) => {
                                    const colors = getScoreColor(score);
                                    return (
                                        <div
                                            key={criterion}
