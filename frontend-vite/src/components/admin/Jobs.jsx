        ...
        <div className="space-y-6 p-6">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full lg:w-auto">
                    ...
                    <button
                        ...
                        className="bg-gradient-to-r from-blue-600 to-purple-600 hover:scale-105 text-white px-6 py-3 rounded-xl font-semibold transition-all flex items-center justify-center space-x-2 shadow-lg shadow-blue-500/20"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <StatCard
                    ...
                    value={data.reduce((acc, j) => acc + (j.applicant_count || 0), 0)}
                    icon={<FaUsers />}
                    color="green"
                />
