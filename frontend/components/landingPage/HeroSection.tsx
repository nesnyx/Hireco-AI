            ...
            <div className="container mx-auto px-6">
                <div className="text-center max-w-4xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20 fade-in-up" style={{ animationDelay: '0.6s' }}>
                        <Button href={"/login"} size="xl" variant="primary" className="w-full sm:w-auto">
                            Start Here
                        </Button>
                            ...
                            return (
                                <div key={index} className="text-center">
                                    <div className="flex items-center justify-center mb-4">
                                        <div className="p-3 bg-linear-to-r from-blue-600/20 to-purple-600/20 rounded-xl border border-slate-700">
