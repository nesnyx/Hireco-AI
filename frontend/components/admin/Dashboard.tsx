                ...
                <div className="bg-slate-800 border border-slate-700 rounded-xl p-6 hover:bg-slate-750 transition-colors">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-bold text-white mt-2">
                                {applicant.length > 0 ?
                                    Math.round(applicant.reduce((acc:any, app:any) => acc + app.score, 0) / applicant.length) : 0}
                            </p>
                        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-slate-800 border border-slate-700 rounded-xl p-6">
                    ...
                    <div className="space-y-4">
                        {jobs.length > 0 ? (
                            jobs.slice(0, 5).map((job:any, idx:any) => (
                ...
                <div className="bg-slate-800 border border-slate-700 rounded-xl p-6">
                    ...
                    <div className="space-y-4">
                        {applicant.length > 0 ? (
                            applicant.slice(0, 5).map((app:any, idx:any) => {
