...
class CriteriaMatchDetail(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    cv_analysis_id = Column(Integer, ForeignKey("cv_analysis.id", ondelete="CASCADE"), nullable=False, index=True)
...
class UserFeedback(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    cv_analysis_id = Column(Integer, ForeignKey("cv_analysis.id", ondelete="CASCADE"), nullable=False, index=True)
    account_id = Column(Integer, ForeignKey("accounts.id", ondelete="SET NULL"), index=True)
...
class Pricing(Base):
    ...
    features = Column(JSONB) # Simpan list fitur dalam format JSON
...
class UserSubscription(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    account_id = Column(Integer, ForeignKey("accounts.id", ondelete="CASCADE"), nullable=False, index=True)
    pricing_id = Column(Integer, ForeignKey("pricing.id", ondelete="SET NULL"), index=True)
